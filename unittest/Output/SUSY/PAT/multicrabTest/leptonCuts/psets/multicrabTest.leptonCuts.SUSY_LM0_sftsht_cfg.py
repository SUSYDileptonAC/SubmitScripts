...
process.MessageLogger = cms.Service('MessageLogger',
  multicrabTest_leptonCuts_SUSY_LM0_sftsht = cms.untracked.PSet( 
  ...
  destinations = cms.untracked.vstring('multicrabTest_leptonCuts_SUSY_LM0_sftsht')
)
...
process.TFileService = cms.Service('TFileService', fileName = cms.string('multicrabTest.leptonCuts.SUSY_LM0_sftsht.root'))
