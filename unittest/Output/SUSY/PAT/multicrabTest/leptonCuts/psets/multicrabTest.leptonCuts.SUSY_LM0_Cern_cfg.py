...
process.MessageLogger = cms.Service('MessageLogger',
  multicrabTest_leptonCuts_SUSY_LM0_Cern = cms.untracked.PSet( 
  ...
  destinations = cms.untracked.vstring('multicrabTest_leptonCuts_SUSY_LM0_Cern')
)
...
process.TFileService = cms.Service('TFileService', fileName = cms.string('multicrabTest.leptonCuts.SUSY_LM0_Cern.root'))
