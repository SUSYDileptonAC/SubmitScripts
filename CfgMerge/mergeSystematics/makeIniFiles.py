...
basePath = /net/data_cms1b/user/teroerde/Cleaning/SystematicTrees/%s
MCDatasets = .*
counterSum = True
outPath = /net/data_cms1b/user/teroerde/ProcessedTrees/SystematicTrees/m_sbottom_%s_m_neutralino_%s
...
"""
        ...
        sbottom_masses = [1000,1050,1100,1150,1200,1250,1300,1350,1400,1450,1500]
