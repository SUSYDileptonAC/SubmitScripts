...
def findLastRetry(path):
    ...
    if getLatestCrabVersion([0,2007002,2007004,2007005, 2007007, 2007008, 2008001,2008002,2008003,2008004,2008005,2008006,2008007,2008008]) == 2007002:
        expr = re.compile(path.replace(".root","_([0-9]*).root"))
    elif getLatestCrabVersion([0,2007002,2007004,2007005, 2007007, 2007008, 2008001,2008002,2008003,2008004,2008005,2008006,2008007,2008008]) > 2007002:
